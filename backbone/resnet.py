...
__all__ = ['resnet18_encoder', 'resnet34_encoder', 'resnet50_encoder', 'resnet101_encoder',
           'resnet50w2x_encoder', 'resnet50w4x_encoder', 'resnet200w2x_encoder', 'resnet50w2x_cls']
...
def resnet50w4x_encoder(**kwargs):
    return ResNet(Bottleneck, [3, 4, 6, 3], width_multiplier=4, **kwargs)


def resnet200w2x_encoder(**kwargs):
    return ResNet(Bottleneck, [3, 24, 36, 3], width_multiplier=2, **kwargs)
